"""Load shared `output.format` from conf/ka_output_format.yml and merge with per-agent instructions."""
from __future__ import annotations

from pathlib import Path

ROOT = Path(__file__).resolve().parent.parent.parent.parent
SHARED_OUTPUT_FORMAT_PATH = ROOT / "conf" / "ka_output_format.yml"
